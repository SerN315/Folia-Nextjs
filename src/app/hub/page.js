      ...
      <main className="hub">
        ...
        <div className="content">
          ...
          <div className="description">
            <p>
              At Folia, we&apos;re your one-stop-shop for mastering multiple
              subjects. Explore a wide range of topics carefully chosen to
              improve your language skills and academic abilities. Our goal is
              simple: to change how you learn, making it easier and more
              enjoyable for everyone, no matter where you come from or what your
              budget is.
            </p>
            <p>
              With our passion for global education, we break down barriers,
              offering opportunities for learning across borders, online, and
              abroad. Whether you&apos;re starting a language journey or
              considering studying internationally, Folia is here to support you
                ...
                <div className="item">
                  ...
                  <div className="text">
                    ...
                    <p>
                      ...
                      English through our topic-based courses, games and
                      practice excercises
                    </p>
                  </div>
                </div>
              ...
              <Link href="/subhome?topic=folia-asvab" className="link link--asvab">
                <div className="item">
                  ...
                  <div className="text">
                    <h4>ASVAB</h4>
                    <p>
                      Ace your Armed Services Vocational Aptitude Battery
                      (ASVAB) certificate with our learning exercises, detailed
                      explanation and practice questions
                    </p>
                  </div>
                </div>
              </Link>
