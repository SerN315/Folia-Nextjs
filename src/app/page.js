      ...
      <main className="landing-page">
        <section id="hero">
          ...
          <div className="content">
            <div className="content__container">
              ...
              <p>
                We stands out by offering a plethora of subjects for
                exploration, transcending traditional learning platforms,
        ...
        <section className="info">
          <div className="info__text">
            ...
            <p>
              Welcome to Folia! Our multi-subject learning platform is designed
              for beginners, offering a diverse array of tools and resources.
        ...
        <section className="info info--reverse info--pre">
          <div className="info__text">
            ...
            <p>
              We strive to bring knowledge to everyone through our tailored
              courses for learning new topics and subjects. Folia also offers
              multiple games, quizzes, and interactive activities to help you
              keep up with the pace and make learning more enjoyable for than
              ever before.
            </p>
          </div>
          <div className="info__img">
                ...
                <div className="list__item list__item--nclex">
                  ...
                  <div className="text">
                    ...
                    <p>
                      ...
                      Registered Nurse in the US and Canada.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="info">
          <div className="info__text">
            ...
            <p>
              As peers, learners and students, we know the journey in learning
              can be sometimes hard, because of that, FOLIA was built as a
              learning tool for students and learners all around the world to
              fasten the learning process while making the learning journey even
        ...
        <section className="info info--final">
          <div className="info__text">
            ...
            <p>
              ...
              interactive lessons, expert guidance, and personalized learning
